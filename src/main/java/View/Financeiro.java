...
public class Financeiro extends javax.swing.JFrame {
    ...
    private GerenciarFinancaController controller;
     ...
     * @param controller
     */
    public Financeiro(Academia academia, GerenciarFinancaController controller) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Realizar Lançamento");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean receita;
        if(jComboBox1.getSelectedItem().equals("Receita")){
            receita = true;
        }else{
            receita = false;
        }
        Lancamento lancamento = new Lancamento(
                jTextCategoria.getText(),
                valor, 
                receita
        );
