...
public class CadastrarAluno extends javax.swing.JFrame {
     ...
     * @param controller
     */
    public CadastrarAluno(Academia academia, GerenciarAlunoController controller) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Cadastrar Aluno");
        ...
        jLabelSubtitulo.setText("Digite os dados do aluno nos campos abaixo");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Aluno aluno = new Aluno(
                ...
                jTextEmail.getText(), 
                jTextCartao.getText());
        if(controller.buscarAluno(jTextCPF.getText()) == null){
